...
visualize_stereo_features = False # CHANGE THIS VARIABLE IF YOU WANT TO SEE THE VISUAL FEATURES
...
(fig, axes) = plt.subplots(nrows=2, ncols=1, sharex=True, num='Position and Velocity vs Time')
x = state['x']
x_des = flat['x']
ax = axes[0]
...
# print(state.keys(), est_state.keys())
(fig, axes) = plt.subplots(nrows=2, ncols=1, sharex=True, num='Acceleration and Jerk vs Time')
# x = state['a']
x_ddot = flat['x_ddot']
ax = axes[0]
# ax.plot(sim_time, x[:,0], 'r',    sim_time, x[:,1], 'g',    sim_time, x[:,2], 'b', linewidth=1, alpha=0.6)
ax.legend(('x', 'y', 'z'), loc='upper right')
ax.plot(sim_time, x_ddot[:,0], 'r.', sim_time, x_ddot[:,1], 'g.', sim_time, x_ddot[:,2], 'b.', linewidth=2.5)
ax.set_ylabel('acceleration, m/s^2')
ax.grid('major')
ax.set_title('Acceleration and Jerk vs Time')
...
# ax.plot(sim_time, v[:,0], 'r',    sim_time, v[:,1], 'g',    sim_time, v[:,2], 'b', linewidth=1,alpha=0.6)
ax.legend(('x', 'y', 'z'), loc='upper right')
ax.plot(sim_time, jerk_des[:,0], 'r.', sim_time, jerk_des[:,1], 'g.', sim_time, jerk_des[:,2], 'b.', linewidth=2.5)
